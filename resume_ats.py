...
buffered = BytesIO()
logo.resize((100, 50)).save(buffered, format="PNG")
...
st.markdown(f"""
    <style>
        ...
        /* Sidebar should slide *under* the navbar */
...
if not resume_files or not jd_file:
    ...
    # Add Dropdown options for "Missing Skills" and "Matching Skills"
    ...
    # Define dropdown for Missing Skills and Matching Skills
